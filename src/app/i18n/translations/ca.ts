...
export const ca: Record<TranslationKey, string> = {
  ...
  'daily.estFinishBalance': 'Sortida (amb balanç):',
  'daily.balanceCovered': 'Balanç total al dia!',
  ...
  'gistSync.notifTitle': 'La còpia al núvol té més dades',
  'gistSync.notifBody': 'La còpia al núvol té {remote} registres davant de {local} aquí. Vols baixar-los?',
  'gistSync.bringBtn': 'Baixar del núvol',
  'gistSync.dismissBtn': 'Descartar',
  'gistSync.sectionTitle': 'Sincronització al núvol',
  'gistSync.sectionHint': 'Opcional. Sincronitza les teves dades amb el teu propi Gist privat de GitHub.',
  'gistSync.tokenLabel': 'Token d\'accés',
  'gistSync.tokenHint': 'Personal Access Token (classic) amb l\'scope mínim "gist".',
  'gistSync.gistLabel': 'ID o URL del gist',
  'gistSync.fileLabel': 'Nom del fitxer',
  'gistSync.saveConfigBtn': 'Desa la configuració',
  'gistSync.configSaved': 'Configuració de sincronització desada.',
  'gistSync.pushBtn': 'Pujar al núvol',
  'gistSync.pullBtn': 'Baixar del núvol',
  'gistSync.pushed': 'Pujat al núvol.',
  'gistSync.pulled': 'Baixat del núvol.',
  'gistSync.pulledEmpty': 'El fitxer del núvol és buit; res a importar.',
  'gistSync.pullConfirm': 'Això reemplaça les dades locals per la còpia del núvol. Vols continuar?',
  'gistSync.busy': 'Sincronitzant…',
  'gistSync.errNoConfig': 'Configura primer el token i l\'ID del gist.',
  'gistSync.errUnauthorized': 'Token no vàlid o caducat, o falta l\'scope "gist" (401).',
  'gistSync.errNotFound': 'Gist no trobat, o el token no hi pot accedir (404).',
