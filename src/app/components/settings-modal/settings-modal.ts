...
type TabId = 'schedule' | 'tracking' | 'focus' | 'data';
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="flex flex-col">
                      ...
                      <span class="text-[11px] text-slate-400 leading-tight">{{ tab.description }}</span>
                    </span>
                  </button>
                </li>
              }
  ...
  readonly tabs: Tab[] = [
    {
      id: 'schedule',
      label: 'Work schedule',
      description: 'Workday & week setup',
    ...
    },
    {
      id: 'data',
      label: 'Data',
      description: 'Export, import, reset',
