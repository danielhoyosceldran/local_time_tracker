      ...
      @if (showSettings()) {
        <div class="absolute inset-0 bg-black/50 flex items-center justify-center p-4 z-20">
          <div class="bg-white rounded-xl p-6 w-full max-w-md">
            <h3 class="text-lg font-bold mb-4 text-slate-900">{{ 'agenda.modalTitle' | t }}</h3>
            ...
            <input
              type="text"
              [(ngModel)]="editingUrl"
              [placeholder]="'agenda.urlPlaceholder' | t"
